# FinSight AI Service | FinSight 졸업작품 AI 마이크로서비스

> **2026 졸업작품 FinSight의 FastAPI AI 서비스** — 뉴스 수준별 재작성, 금융 용어의 문맥 설명, 투자 판단 피드백을 담당하는 내부 서비스

FinSight는 초보 투자자가 경제 뉴스를 단순히 읽는 데서 그치지 않고, 뉴스의 근거와 시장 영향을 이해하도록 돕습니다. 이 저장소는 사용자가 직접 접근하는 앱 서버가 아니라, Spring Boot 백엔드가 호출하는 AI 기능을 독립적으로 분리한 마이크로서비스입니다.

### AI 서비스의 역할

`원문 뉴스 → 사용자 수준별 설명 / 금융 용어 풀이 / 판단 결과 피드백`
